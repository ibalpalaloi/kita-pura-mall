    ...
    <main id="homepage" class="homepage">
        <div class="card-mall">
            <div class="card-body" style="padding-top: 2em;">
                <form method="post" action="<?=url('/')?>/lupa_password/kirim_kode" id="form_input">
                    {{ csrf_field() }}
                    <input type="text" name="id_user" value="{{$user->id}}" hidden>
                    <div class="radio">
                        <label><input type="radio" name="radio" value="email" checked>{{$user->email}}</label>
                      </div>
                      <div class="radio">
                        <label><input type="radio" name="radio" value="whatsapp">{{$user->no_hp}}</label>
                      </div>
