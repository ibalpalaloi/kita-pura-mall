    ...
    <main id="homepage" class="homepage">
        <div class="card-mall">
            <div class="card-body" style="padding-top: 2em;">
                <p>Kode Otp Dikirimkan ke akun {{$kode->jenis}} anda</p>
                <form method="post" action="<?=url('/')?>/lupa_password/post_kode" id="form_input">
                    {{ csrf_field() }}
                    @if (\Session::has('error'))
                         <p style="color: red">Kode Salah</p>
                    @endif  
                    <input type="text" name="id_user" value="{{$kode->user_id}}" hidden>
