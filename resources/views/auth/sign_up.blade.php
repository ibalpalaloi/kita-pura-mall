...
<body style="margin: 0px; background: #fb036b;">
	...
	<form action="<?=url('/post_sign_up')?>" method="post">
		{{csrf_field()}}
		<div class="wrapper" style="background: #fb036b; margin-top: 8em; display: flex; flex-direction: column; justify-content: center;">
			...
			<div class="container-mall" style="display: flex; justify-content: space-around;">
				<div class="footer-mall-menu" style="width: 90%; height: 3.5em; display: flex; align-items: center; justify-content: space-around;">
					<div>
						<input readonly value="{{$no_telp}}" name="no_telp" type="text" name="no_telp" class="form-control" style="width: 100% !important; padding: .375rem; border: none; text-align: center;">
					</div>
				</div> 
			</div>
			<div class="container-mall" style="display: flex; justify-content: space-around;">
				<div class="footer-mall-menu" style="width: 90%; height: 3.5em; display: flex; align-items: center; justify-content: space-around;">
					<div>
						<input name="password" type="text" name="password" class="form-control" style="width: 100% !important; padding: .375rem; border: none; text-align: center;" placeholder="Password">
					</div>
				</div> 
			</div>
			<div class="container-mall" style="display: flex; justify-content: space-around;">
