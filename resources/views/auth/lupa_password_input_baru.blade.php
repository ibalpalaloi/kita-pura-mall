    ...
    <main id="homepage" class="homepage">
        <div class="card-mall">
            <div class="card-body" style="padding-top: 2em;">
                ...
                <form method="post" action="<?=url('/')?>/lupa_password/post_new_password" id="form_input">
                    {{ csrf_field() }}
                     
                    <input type="text" name="id_user" value="{{$user->id}}" hidden>
                    <div class="form-group">
                        <label for="exampleEmail" class="bmd-label-floating" id="label_kode_otp" style="color: #999797">Masukkan Password Baru Anda</label>
...
<script type="text/javascript">
    function cek_submit(){
        ...
        if(status_password = 0){
            ...
            $('#label_kode_otp').text('Password minimal 8 karakter');
        }
        else{
            $('#form_input').submit();
        }
