...
<main id="homepage" class="homepage" style="background: #eaf4ff;">
	...
	<div class="row-mall" style="padding: 0.7em 0.7em 1.2em 0.7em; margin-top: -3em;">
		<div style="margin-left: 0.9em; font-size: 1.2em; font-weight: 1000;">Bosan?</div>
		<div style="margin-left: 1.2em; font-size: 0.7em;">hilangkan rasa bosanmu segera! download berbagai macam hiburan hanya di kitapuramall</div>
