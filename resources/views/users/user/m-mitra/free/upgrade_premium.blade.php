...
<form enctype="multipart/form-data" action="{{url()->current()}}/simpan" method="post">
	...
	<main id="homepage" class="homepage" style="padding: 0px; background: #eaf4ff; margin-top: 2em; border-radius: 1.5em;">
		<div class="card-mall kategori" style="display: flex; justify-content: center; position: relative; flex-direction: column; align-items: center; background: #eaf4ff;">
			<div style="width: 90%; margin-top: 4em; display: flex; flex-direction: column; align-items: center;">
				<div class="input-group mb-3 div-input-mall" id="div_nama_toko">
					...
					<div>
						...
						<input type="text" class="form-control-mall" id="nama_toko" name="nama_toko" onfocus="input_focus(this.id)" onblur="input_blur(this.id)" placeholder="Masukan nama toko" aria-label="Nama Toko" aria-describedby="basic-addon1" style="width: 100%;" value="{{$toko->nama_toko}}" required>
					</div>
				</div>
