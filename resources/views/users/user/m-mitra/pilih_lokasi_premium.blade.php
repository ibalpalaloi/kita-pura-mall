...
<div class="footer" style="background: #eaf4ff;">
	...
	<div class="container-mall" id="tampil_alamat" style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding-bottom: 1em;">
		<div style="display: flex; width: 100%; justify-content: space-between;">
			...
			<div id="btn_koordinat" style="width: 15%; border: 2px solid #ffaa00; margin-bottom: 1.1em; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
				<img src="<?=url('/')?>/public/img/icon_svg/loading_yellow.gif" style="width: 50%;">
			</div>
			<div id="btn_koordinat_ditemukan" style="width: 15%; border: 2px solid #ffaa00; margin-bottom: 1.1em; border-radius: 50%; display: flex; align-items: center; justify-content: center;" hidden onclick="tampilkan_titik()">
		...
		<button onclick="simpan_lokasi()" id="btn_simpan_lokasi" class="btn btn-primary" style="background: #ffaa00;border: 1px solid #ffaa00; border-radius: 1.5em; padding: 0.5em 2em 0.5em 2em; width: 100%;">Simpan Lokasi
		</button>
	</div>
