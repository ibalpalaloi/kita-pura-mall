    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="padding: 0px;">
        <div class="modal-content"
            ...
            <div id="jadwal_sample" style="width: 100%; display: flex; justify-content: center;" hidden>
                <div class="input-group mb-3 div-input-mall-square" id="harinya"
                    ...
                    <div style="width: 20%; display: flex; justify-content: center; margin-left: 3%;">
                        <div
                            style="width: 2.5em; height: 2.5em; background:#ffaa00; margin: 0.5em; border-radius: 50%; vertical-align: middle; color: white; padding: 0;line-height: 2.3em; text-align: center;">
                            simbolnya</div>
                    </div>
                    ...
                    <div onclick='hapus_jadwal("harinya")'
                        style="width: 15%; cursor: pointer; display: flex; align-items: center; background: #ffaa00; justify-content: center; border-top-right-radius: 0.5em; border-bottom-right-radius: 0.5em; color: white; font-weight:700; font-size: 1.2em;">
                        X</div>
                </div>
            </div>
            ...
            <button onclick="tambah_jadwal()" class="btn btn-primary"
                style="background: #ffaa00;;border: 1px solid #ffaa00; border-radius: 1.5em; padding: 0.5em 2em 0.5em 2em; width: 90%; margin-bottom: 1em;">Tambah
                Jadwal
            </button>
        </div>
    </div>
...
<form enctype="multipart/form-data" action="<?=url('/')?>/akun/jadi-mitra/{{Request::segment(3)}}/simpan" method="post">
    ...
    <div class="wrapper" style="background: #eaf4ff; position: relative; z-index: 2; top: -2.5em;">
        <div class="banner" style="position: relative;">
            ...
            <div
                style="position: absolute; top: 7.5em; left: 5%; width: 90%; height: 90%; display: flex; justify-content: center; align-items: center; flex-direction: column; background: white; border-radius: 1.5em;">
                <div id="div_pic_toko"
                    style="padding: auto 0; border:2px dashed #ffaa00; display: flex; justify-content: center; align-items: center; border-radius: 50%; width: 50%; height: 50%;">
                    <img id="pic_toko" src="<?=url('/')?>/public/img/icon_svg/add_circle_yellow.svg"
                        onclick="tambah_foto_toko()">
                </div>
                <div id="div_pic_toko_privew"
                    style="position: relative; padding: auto 0; display: flex; justify-content: center; align-items: center; border-radius: 50%; width: 50%; height: 50%; border: 2px solid #b3b6bc;"
                    hidden>
                    <img id="pic_toko_privew" src="<?=url('/')?>/public/img/img.jpg"
                        style="width: 100%; border-radius: 50%; object-fit: cover;height: 100%;">
                    <img id="pic_toko" src="<?=url('/')?>/public/img/icon_svg/add_circle_yellow.svg"
                        onclick="tambah_foto_toko()" style="position: absolute; right: 0px; bottom: 0px;">
                </div>
                <div style="font-weight: 600; color: black; font-size: 1.3em; margin-top: 0.5em;">Logo Toko</div>
                <div
                    style="color: #b3b6bc; font-size: 1em; margin-top: 0em;  font-size: 0.8em; line-height: 1.3em; width: 100%; padding: 0em 10%;">
                    logo toko sangat penting untuk membantu branding kepada masyarakat. dan membantu pengindentifikasian
                    toko</div>
    ...
    <main id="homepage" class="homepage"
        style="padding: 0px; background: #eaf4ff; margin-top: 2em; border-radius: 1.5em;">
        <div class="card-mall kategori"
            style="display: flex; justify-content: center; position: relative; flex-direction: column; align-items: center; background: #eaf4ff;">
            <div style="width: 90%; margin-top: 1em; display: flex; flex-direction: column; align-items: center;">
                <div class="input-group mb-3 div-input-mall" id="div_nama_toko">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control-mall" id="nama_toko" name="nama_toko"
                            ...
                            aria-label="Nama Toko" aria-describedby="basic-addon1" style="width: 100%;" required>
                    </div>
                </div>
                ...
                <div class="input-group mb-3 div-input-mall" id="div_no_hp">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control-mall" id="no_hp" name="no_hp"
                            onfocus="input_focus(this.id)" onblur="input_blur(this.id)"
                            placeholder="Masukan nomor hp toko" aria-label="Nomor Handphone Toko"
                            aria-describedby="basic-addon1" style="width: 100%;" required>
                    </div>
                </div>
                ...
                <div class="input-group mb-3 div-input-mall" id="div_alamat">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control-mall" id="alamat" name="alamat"
                            ...
                            aria-label="alamat" aria-describedby="basic-addon1" style="width: 100%;">
                ...
                <div class="input-group mb-3 div-input-mall" id="div_no_hp"
                    style="height: 20em; justify-content: flex-start;">
                    <span style="margin-top: 0px;">Deskripsi</span>
                    <div style="height: 15em; width: 100%;">
                        <textarea class="form-control-mall" id="deskripsi" name="deskripsi" onblur="input_blur(this.id)"
                            onfocus="input_focus(this.id)"
                            style="width: 100%; height: 15em; border-radius: 0px; margin: 0.6em;" rows="8"
                            required></textarea>
                    </div>
                </div>
                <div class="input-group mb-3 div-input-mall-square" id="div_foto_toko"
                    ...
                    <div style="display: flex; justify-content: center; width: 100%; border: 2px dashed #FF006E; margin: 0px 10% 2em 10%; height: 11.5em; cursor: pointer;"
                        onclick="tambah_foto_toko_2()" id="div_pic_toko_2">
                        <img src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg" style="width: 2em;">
                    </div>
                    <div style="display: flex; justify-content: center; width: 100%; margin: 0px 10% 2em 10%; height: 11.5em;"
                        id="div_pic_toko_privew_2" hidden>
                        <img id="pic_toko_privew_2" src="<?=url('/')?>/public/img/img.jpg"
                            style="width: 100%; object-fit: cover;height: 100%;">
                        <img id="pic_toko_2" src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg"
                            onclick="tambah_foto_toko_2()" style="position: absolute; right: 1em; bottom: 1em;">

                    </div>
                    <input hidden type="file" name="foto_toko_2" id="foto_toko_2">

                    <div style="display: flex; justify-content: center; width: 100%; border: 2px dashed #FF006E; margin: 0px 10% 2em 10%; height: 11.5em; cursor: pointer;"
                        onclick="tambah_foto_toko_3()" id="div_pic_toko_3">
                        <img src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg" style="width: 2em;">
                    </div>
                    <div style="display: flex; justify-content: center; width: 100%; margin: 0px 10% 2em 10%; height: 11.5em;"
                        id="div_pic_toko_privew_3" hidden>
                        <img id="pic_toko_privew_3" src="<?=url('/')?>/public/img/img.jpg"
                            style="width: 100%; object-fit: cover;height: 100%;">
                        <img id="pic_toko_3" src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg"
                            onclick="tambah_foto_toko_3()" style="position: absolute; right: 1em; bottom: 1em;">
                    </div>
                    <input hidden type="file" name="foto_toko_3" id="foto_toko_3">

                    <div style="display: flex; justify-content: center; width: 100%; border: 2px dashed #FF006E; margin: 0px 10% 2em 10%; height: 11.5em; cursor: pointer;"
                        onclick="tambah_foto_toko_4()" id="div_pic_toko_4">
                        <img src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg" style="width: 2em;">
                    </div>
                    <div style="display: flex; justify-content: center; width: 100%; margin: 0px 10% 2em 10%; height: 11.5em;"
                        id="div_pic_toko_privew_4" hidden>
                        <img id="pic_toko_privew_4" src="<?=url('/')?>/public/img/img.jpg"
                            style="width: 100%; object-fit: cover;height: 100%;">
                        <img id="pic_toko_4" src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg"
                            onclick="tambah_foto_toko_4()" style="position: absolute; right: 1em; bottom: 1em;">
                    </div>
                    <input hidden type="file" name="foto_toko_4" id="foto_toko_4">
                </div>
            </div>
            <button type="submit" class="btn btn-primary"
                style="background: #ffaa00; margin-top: 0.5em;border: 1px solid #ffaa00; border-radius: 1.5em; padding: 0.5em 2em 0.5em 2em; width: 70%;">Simpan
            </button>
...
<script type="text/javascript">
	...
	function readURL_2(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                $('#pic_toko_privew_2').attr('src', e.target.result);
                $("#div_pic_toko_privew_2").prop('hidden', false);
                $("#div_pic_toko_2").prop('hidden', true);
            }
    ...
    $("#foto_toko_2").change(function () {
        readURL_2(this);
    });


	function tambah_foto_toko_3() {
        $("#foto_toko_3").click();
    }
	...
	function readURL_3(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                $('#pic_toko_privew_3').attr('src', e.target.result);
                $("#div_pic_toko_privew_3").prop('hidden', false);
                $("#div_pic_toko_3").prop('hidden', true);
            }
    ...
    $("#foto_toko_3").change(function () {
        readURL_3(this);
    });

	function tambah_foto_toko_4() {
        $("#foto_toko_4").click();
    }
	...
	function readURL_4(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                $('#pic_toko_privew_4').attr('src', e.target.result);
                $("#div_pic_toko_privew_4").prop('hidden', false);
                $("#div_pic_toko_4").prop('hidden', true);
            }
