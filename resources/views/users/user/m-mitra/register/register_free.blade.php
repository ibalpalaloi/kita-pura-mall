...
<div class="modal fade" id="modal-jadwal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-bottom" role="document" style="padding: 0px;">
        <div class="modal-content"
            style="border-top-right-radius:1.2em; border-top-left-radius: 1.2em; background: #eaf4ff; display: flex; justify-content: center; align-items: center;">
...
<main id="homepage" class="homepage" style="padding: 0px;background: #eaf4ff;">
    <div class="card-mall kategori"
        ...
        <img src="<?=url('/')?>/public/img/mitra/mitra_free.png" width="75%"
            style="top: -11em; position: relative; overflow-x: visible; z-index: 3 !important;">
        ...
        <form enctype="multipart/form-data" action="<?=url('/')?>/akun/jadi-mitra/{{Request::segment(3)}}/simpan"
            method="post"
            style="width: 90%; margin-top: 2em;  display: flex; flex-direction: column; align-items: center;">
            {{csrf_field()}}
            ...
            <div class="input-group mb-3 div-input-mall-square" id="div_foto_toko"
                ...
                <div style="display: flex; justify-content: center; width: 100%; border: 2px dashed #FF006E; margin: 0px 10% 2em 10%; height: 11.5em; cursor: pointer;"
                    onclick="tambah_foto_toko()" id="div_pic_toko">
                ...
                <div style="display: flex; justify-content: center; width: 100%; margin: 0px 10% 2em 10%; height: 11.5em;"
                    id="div_pic_toko_privew" hidden>
                    <img id="pic_toko_privew" src="<?=url('/')?>/public/img/img.jpg"
                        style="width: 100%; object-fit: cover;height: 100%;">
                    <img id="pic_toko" src="<?=url('/')?>/public/img/icon_svg/add_circle_pink.svg"
                        onclick="tambah_foto_toko()" style="position: absolute; right: 1em; bottom: 1em;">
