				...
				?>
                    ...
                    <div class="input-group mb-3 div-input-mall" id="div_no_hp" style="width: 90%;">
                        <select type="text" class="form-control form-control-mall-modal" id="jadwal" name="jadwal"
                            ...
                            @for ($i = 0; $i < count($var_text); $i++) @php $indikator=false; @endphp @for ($j=0; $j <
                                count($loop_hari); $j++) @if ($loop_hari[$j]==$var_text[$i]) @php $indikator=true;
                                @endphp @endif @endfor @if ($indikator==false) <option value="{{$var_value[$i]}}">
                                {{$var_text[$i]}}
                                </option>
                                @endif
                                @endfor
    ...
    <div class="card-mall kategori"
        ...
        <form enctype="multipart/form-data" action="<?=url('/')?>/user/jadi-mitra/{{Request::segment(3)}}/simpan" method="post"
            ...
            <div class="input-group mb-3 div-input-mall" id="div_nama_pemilik">
                ...
                <input type="text" class="form-control form-control-mall" id="nama_pemilik" name="nama_pemilik"
                    onfocus="input_focus(this.id)" onblur="input_blur(this.id)" placeholder="Nama Pemilik"
                    aria-label="Nama Pemilik" aria-describedby="basic-addon1" value="{{$pemilik}}" required>
            </div>
            ...
            <div class="input-group mb-3 div-input-mall" id="div_no_hp">
                ...
                <input type="text" class="form-control form-control-mall" id="no_hp" name="no_hp"
                    onfocus="input_focus(this.id)" onblur="input_blur(this.id)" placeholder="Nomor Handphone"
                    aria-label="no_hp" aria-describedby="basic-addon1" value="{{$no_hp}}" required>
            </div>
            <div class="input-group mb-3 div-input-mall" id="div_no_hp">
                <div class="input-group-prepend">
                    <span class="input-group-text input-group-text-mall">
                ...
                <select type="text" class="form-control form-control-mall" id="kategori_toko" name="kategori_toko"
                    onfocus="input_focus(this.id)" onblur="input_blur(this.id)" style="height: 3em;" required>
                    <option value="" selected>--- Pilih Kategori Toko ---</option>
                    @foreach($daftar_kategori as $row)
                    <option value="{{$row->id}}" @if($kategori==$row->id ) selected='selected' @endif>{{$row->nama}}
                    </option>
                    @endforeach
            ...
            <div class="input-group mb-3 div-input-mall" id="div_jadwal">
                ...
                <div onclick="pilih_jadwal()" class="form-control form-control-mall"
                    style="vertical-align: center;display: flex; align-items: center; cursor: pointer;"
                    id="pilih_jadwal_buka_toko">--- Pilih Jadwal Buka Tutup ---</div>
            </div>
            <div>
            ...
            <div class="input-group mb-3 div-input-mall" id="div_username">
                ...
                <div onclick="pilih_lokasi()" class="form-control form-control-mall"
                    style="vertical-align: center;display: flex; align-items: center; cursor: pointer;">--- Pilih
                    Lokasi ---</div>
            </div>
            <?php 
			} else {
            ...
            <div style="display: flex; justify-content: space-between;">
                <div class="input-group mb-3 div-input-mall" id="div_latitude">
                    ...
                    <input type="text" class="form-control form-control-mall" id="latitude" name="latitude"
                        ...
                        aria-label="latitude" aria-describedby="basic-addon1" value="{{$latitude}}">
                </div>
                <div class="input-group mb-3 div-input-mall" id="div_longitude">
                    ...
                    <input type="text" class="form-control form-control-mall" id="longitude" name="longitude"
                        ...
                        aria-label="longitude" aria-describedby="basic-addon1" value="{{$longitude}}">
                </div>
            </div>
            <div class="input-group mb-0 div-input-mall" id="div_alamat">
                ...
                <input type="text" class="form-control form-control-mall" id="alamat" name="alamat"
                    ...
                    aria-describedby="basic-addon1" value="{{$alamat}}">
            </div>
