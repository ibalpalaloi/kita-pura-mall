	...
	<div class="modal-dialog modal-dialog-centered" role="document" style="padding: 0px;">
		<div class="modal-content" style="border-radius: 1.2em; background: #eaf4ff; display: flex; justify-content: center; align-items: center;">
			...
			<div class="input-group mb-3 div-input-mall" id="div_no_hp" style="width: 90%;">
				<select type="text" class="form-control form-control-mall-textarea" id="jadwal" name="jadwal" onfocus="input_focus(this.id)" onblur="input_blur(this.id)" aria-label="jadwal" aria-describedby="basic-addon1" style="width: 100%; text-align: center !important;">
...
<header class="style__Container-sc-3fiysr-0 header" style="background: #e18f00;">
	<div class="style__Wrapper-sc-3fiysr-2 hBSxmh" style="display: flex; justify-content: space-between;">
		<a href="<?=url('/')?>/user/jadi-mitra/premium/register" style="padding-left: 1em;">
...
<main id="homepage" class="homepage" style="padding: 0px; background: #eaf4ff;">
	<div class="card-mall kategori" style="display: flex; justify-content: center; position: relative; flex-direction: column; align-items: center; background: #eaf4ff;">
		...
		<div style="width: 85%; margin-top: 2em; display: flex; flex-direction: column; align-items: center;">
			<div class="input-group mb-3 div-input-mall" id="div_nama_pemilik">
				...
				<input type="text" class="form-control form-control-mall" id="nik" name="nik" onfocus="input_focus(this.id)" onblur="input_blur(this.id)" placeholder="NIK" aria-label="NIK" aria-describedby="basic-addon1" value="{{$pemilik}}">
			</div>
			<div class="input-group mb-3 div-input-mall">
				<textarea type="text" class="form-control form-control-mall-textarea" id="no_hp" name="no_hp" onfocus="input_focus(this.id)" onblur="input_blur(this.id)" placeholder="Masukan deskripsi mengenai usaha anda...." aria-label="no_hp" aria-describedby="basic-addon1" style="padding: 1em; line-height: 1.1em;" rows="8">{{$no_hp}}</textarea>			
			</div>


		</div>

		<a href="<?=url('/')?>/user/jadi-mitra/premium/upload_foto" class="btn btn-primary" style="background: #e18f00; margin-top: 0.5em;border: 1px solid #e18f00; border-radius: 1.5em; padding: 0.5em 2em 0.5em 2em; width: 70%;">Lanjut
		</a>
	</div>
</div>
</main>
