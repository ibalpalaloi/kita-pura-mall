			...
			<div style="width: 90%; margin-top: 1em; display: flex; flex-direction: column; align-items: center;">
				...
				<div class="input-group mb-3 div-input-mall" id="div_no_hp">
					...
					<div>
						...
						<input type="text" class="form-control-mall" id="no_hp" name="no_hp" onfocus="input_focus(this.id)" onblur="input_blur(this.id)" placeholder="Masukan nomor NIK" aria-label="Nomor Handphone Toko" aria-describedby="basic-addon1" style="width: 100%;" required>
					</div>
				</div>
