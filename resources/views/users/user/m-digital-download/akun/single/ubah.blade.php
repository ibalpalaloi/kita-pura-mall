 	...
 	<main id="homepage" class="homepage" style="padding-top: 0em; background: transparent;">
 		<form id="form_input" enctype="multipart/form-data" action="<?=url('/')?>/digital-download/akun/single/{{$album_single->id}}/update" method="post">
 			{{csrf_field()}}
 				...
 				<div style="width: 95%; display: flex; flex-direction: column; align-items: center;">
 					<div style="margin-top: 6em; margin-bottom: 1.5em;">
 						...
 						<div style="position: relative;">
 							...
 							<input type="file" name="foto_cover" id="foto_cover" hidden>
 						</div>
 					</div>
 					...
 					<div class="input-group mb-3 @if($errors->first('no_hp')) is-invalid @endif"  id="div_kategori" style="color: white; padding: 0.5em 1em 1em 1em; border-radius: 0.5em; background: #161616;">
 						...
 						<input type="text" class="form-control-mall" id="judul_single" name="judul" placeholder="Judul Single" aria-describedby="basic-addon1" style="width: 100%; padding-left: 1em;" value="{{$album_single->judul}}" required>
 					</div>
 					<div class="input-group mb-3 @if($errors->first('no_hp')) is-invalid @endif"  id="div_kategori" style="color: white; padding: 0.5em 1em 1em 1em; border-radius: 0.5em; background: #161616;">
 						<div style="margin-top: 0px; color: #B3B6BC; font-weight: 600; font-size: 0.75em; padding: 0.3em 0em 0.7em 0em;">Harga</div>
 						<input type="text" name="judul_foto" id="judul_foto" value="{{$album_single->foto_cover}}" hidden>
 						...
 						<div class="input-group div-musik mb-3" id="div_lagu_1">
 							<div style="display: flex; justify-content: space-between;">
 								<div style="width: 18%; display: flex; justify-content: center; align-content: center;" class="form-control-mall">
 									...
 									<img id="upload_image_1" onclick="upload_lagu('1', 'tambah')" src="<?=url('/')?>/public/img/digital_download/icon_svg/upload_icon.svg" style="width: 50%; margin-right: 0.5em;" hidden>
 									<div id="spinner_image_1" class="spinner-border" role="status" style="margin-top: 0.2em; margin-right: 0.5em;" hidden>
 										<span class="sr-only">Loading...</span>
 									</div>
 									<i id="done_image_1" class="fa fa-check" style="font-size: 1.5em; margin-top: 0.3em; margin-right: 0.4em;"></i>
 								</div>
 								<div style="width: 80%;">
 									<input type="text" class="form-control-mall" id="keterangan_upload" style="width: 100%; padding-left: 1em;" value="Berhasil terunggah" readonly>
 									<input type="text" class="form-control-mall" id="judul_lagu_1" name="judul_lagu_1" placeholder="Judul Lagu" style="width: 100%; padding-left: 1em;" value="{{$album_single->judul}}" hidden>
 									<input type="text" class="form-control-mall" name="nama_file_1" id="nama_file_1" value="{{$album_single->file}}" hidden>
 									<small id="upload_kembali_1" onclick="upload_lagu('1', 'ubah')">Salah upload file? upload kembali</small>
 								</div>
