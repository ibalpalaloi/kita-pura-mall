 		...
 		<div class="footer">
 			<div class="container-mall" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
 				<div style='text-align: left; font-size: 0.75em; padding: 0.7em 0em 0.7em 0.5em; width: 100%; color: white; background-size: cover; position: absolute; bottom: 0em; padding: 0em 8%; bottom: 2em; margin-bottom: 12em;'> 
 					<a href="{{url()->current()}}/ubah" style="position: absolute; bottom: 1em; z-index: 1000; width: 5em; height: 5em; background: linear-gradient(41.88deg, #4AAE20 35.3%, #5EE825 88.34%); box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 50%; right:8%; display: flex; justify-content:center;align-items: center;">
 						<img src="<?=url('/')?>/public/img/digital_download/icon_svg/setting.svg" style="width: 3.5em; height:3.5em;">
 					</a>
 					<div style="font-weight: 650; font-size: 1.8rem; margin-bottom: 0.2em; line-height: 1em;"><?=substr(strip_tags($album_single->judul), 0, 15)?>@if (strlen($album_single->judul) > 15)..@endif</div>
 					<div style="font-size: 0.9rem; line-height: 1em; font-weight: 0;">{{ucfirst($album_single->status)}}</div>
