@extends('layouts.home_digital_akun')
			...
			<div class="modal-body" style="display: flex; justify-content: center; flex-direction: column; align-items: center; margin: 0; width: 90%;">
				...
				<div style="font-size: 1em; text-align: center; width: 100%; font-weight: 0; color: #ffe6f1; margin-bottom: 0.5em;">
					...
					<div style="background: #1E1E1F; padding: 1em 1em; border-radius: 2em; position: relative; margin-top: 0.5em; margin-bottom: 0.5em;">
						<input type="text" id="link_toko_2" style="cursor: pointer; color: white;width: 100%; background: #1E1E1F; font-weight: 500;" value="kitapuramall.com/{{$band->username}}" readonly>
					</div>
					<div class="share_div" style="display: flex; justify-content: center; margin-top: 0.5em;">
						<div id="salin-link-2" class="share_platform" data-toggle="tooltip" data-placement="bottom" title="Salin Link" style="cursor: pointer;" onclick="copy_text('2')">
							...
							<input type="hidden" id="link_toko_2" value="kitapura.com/{{$band->username}}" readonly>
						</div>
						<div onclick="link_fb()" class="share_platform" style="background: #3b5998;">
							<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.m.kitapura.com%2F{{$band->username}}"><i class="fab fa-facebook-f text-white" style="font-size: 1.5em;"></i></a>
						</div>
...
<header class="style__Container-sc-3fiysr-0 header" style="background:#161616; padding-top: 0.3em;">
...
<main id="homepage" class="homepage" style='background: transparent; padding: 5em 0px 0px 0px;'>
	<div>
		<div style="padding: 0.5em 16px 1em;">
					...
					<div style="display: flex; justify-content: space-around;" hidden>
						<div class="item-statis" style="display: flex; justify-content: center;">
							<div style="margin-left: 0.5em;">
								<hr style="border: 3px solid #DD2525; border-radius: 1.5em; width: 1.5em; margin-bottom: 0em;">
		...
		<div style="width: 100%; display: flex; justify-content: center;">
			<div style="width: 80%; background: #1E1E1F; padding: 1em 1.5em; border-radius: 2em; position: relative; margin-top: 0.5em; margin-bottom: 0.5em;" >
				<div id="salin-link-1" data-toggle="tooltip" data-placement="bottom" title="Salin Link" style="cursor: pointer;" onclick="copy_text('1')">
					<input type="text" id="link_toko_1" style="cursor: pointer; color: white;width: 100%; background: #1E1E1F; font-weight: 500;" value="kitapuramall.com/{{$band->username}}" readonly>
				</div>
				<div style="cursor: pointer; width: 2.5em; height: 2.5em; background: #DD2525; border-radius: 50%; display: flex; justify-content: center; position: absolute; right: 0.6em; bottom: 0.6em;" onclick="share_button()"><img src="<?=url('/')?>/public/img/icon_svg/share_white.svg" style="width: 50%;"></div>
			</div>
		</div>
		...
		<div id="menu-band" style="display: flex;justify-content:center;flex-direction: column; align-items: center; padding-bottom: 1.2em;">
			...
			<a onclick="show_loader()" href="<?=url('/')?>/akun/mitra/premium/atur-produk" style="padding-left: 0.4em;">
				<img src="<?=url('/')?>/public/img/button/digital_download/kode_download.svg" style="width: 100%;">
			</a>
			<a onclick="show_loader()" href="<?=url('/')?>/akun/mitra/premium/ubah-landing-page" style="padding-left: 0.4em;">
				<img src="<?=url('/')?>/public/img/button/digital_download/arsip_download.svg" style="width: 100%;">
			</a>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function create_chart(label, jumlah, color, target, margin_top, point_radius, end_data){
		...
		gradientFill.addColorStop(0, "#DD2525");
