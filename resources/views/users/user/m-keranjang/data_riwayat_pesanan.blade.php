    ...
    <div onclick="pindah_halaman('keranjang')">
        <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div onclick="pindah_halaman('terkonfirmasi')">
                ...
                <div onclick="pindah_halaman('riwayat')"  style="background: #EAF4FF;">
                    <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="daftar-product" style="margin-top: 1em;">
                        ...
                        <div class="product" style="display: flex; justify-content: space-between; margin-bottom: 1em;">
                            ...
                            <div class="deskripsi-product" style="width: 47%;"> 
                                <div class="nama" id="nama_{{$row->id}}" style="font-size: 1em; color: {{$page->warna_header}}; font-weight: 500;"><?=ucwords(strtolower(substr(strip_tags($row->nama_product), 0, 35)))?>@if (strlen($row->nama_product) > 35)..@endif</div>
                        ...
                        <script type="text/javascript">
                            ...
                            @else
                            sub_total_current["<?=$daftar_tunggu_konfirmasi[$i]['id_toko']?>"] += <?=$row->harga?>*<?=$row->jumlah?>;
                            @endif	
                            @endif
