            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li class="user-pro">
                        ...
                        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                            <li><a href="javascript:void(0)"><i class="ti-user"></i> <span class="hide-menu">My
                                        Profile</span></a></li>
                            <li><a href="javascript:void(0)"><i class="ti-wallet"></i> <span class="hide-menu">My
                                        Balance</span></a></li>
                    ...
                    <li> <a href="index.html" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i>
                            <span class="hide-menu"> Toko <span class="fa arrow"></span> <span
                                    class="label label-rouded label-inverse pull-right">4</span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?=url('toko/informasi_dasar')?>"><span class="hide-menu">Informasi Dasar</span></a> </li>
                            <li> <a href="index2.html"><span class="hide-menu">Alamat Toko</span></a> </li>
                            <li> <a href="index3.html"><span class="hide-menu">Akun</span></a> </li>
                        </ul>
                    </li>
                    <li> <a href="index.html" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i>
                        <span class="hide-menu"> Produk <span class="fa arrow"></span> <span
                                class="label label-rouded label-inverse pull-right">4</span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="index.html"><span class="hide-menu">Semua Produk</span></a> </li>
                            <li> <a href="index2.html"><span class="hide-menu">Tambah Produk</span></a> </li>
                        </ul>
                    </li>
                    <li class="devider"></li>
