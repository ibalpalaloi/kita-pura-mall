...
<script type="text/javascript">
	...
	var label = ["01", "02", '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'];
	var jumlah = [15, 24, 35, 12, 16, 12, 29, 40, 8, 10, 12, 14];
	// var jumlah = [15, 0, 34, 15, 15, 15, 15, 15, 15, 15, 15, 15];
	var color = ["#ffaa00", "#ffaa00", "#ffaa00", "#ffaa00","#ffaa00", "#ffaa00","#ffaa00", "#ffaa00","#ffaa00", "#ffaa00","#ffaa00", "#ffaa00"];

    //get data
    var maxJumlah = Math.max.apply(Math, jumlah)/2;
    create_chart(label, jumlah, color, "chart-0", maxJumlah);
