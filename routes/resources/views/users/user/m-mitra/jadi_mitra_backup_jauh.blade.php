...
<main id="homepage" class="homepage" style="background: #eaf4ff; display: flex; align-items: center; justify-content: center; flex-direction: column;">
	<div class="slider">
		...
		<div class="slides">
			<div id="slide-1">
				<div style="text-align: center;font-size: 1em; font-weight: 500; line-height: 1.2em;">Daftar usaha anda<span style="color: #fb036b;"> Gratis</span><br>Mudah hanya di kitapura Mall</div>
				<div style="background: white; margin-top: 5em; border-radius: 1.5em; position: relative;">
					<div style="display: flex; justify-content: center; width: 100%; position: absolute; top: -4em;">
					...
					<div class="div-feature" style=" background: white; width: 100%; padding-top: 3em; padding-bottom: 2em; border-bottom-right-radius: 1.5em; border-bottom-left-radius: 1.5em;">
						<div class="feature">
			...
			<div id="slide-1">
				<div style="text-align: center;font-size: 1em; font-weight: 500; line-height: 1.2em;">Mau punya <span style="color: #e18f00;">Landing Page</span> gratis?<br>Daftar mitra Premium di kitapuramall</div>
				<div style="background: white; margin-top: 5em; border-radius: 1.5em; position: relative;">
					<div style="display: flex; justify-content: center; width: 100%; position: absolute; top: -4em;">
	...
	<a href="<?=url('/')?>/user/jadi-mitra/free" class="btn btn-primary" style="background: #fb036b; margin-top: 0.5em;border: 1px solid #fb036b; border-radius: 1.5em; padding: 0.5em 2em 0.5em 2em; width: 40%;">Daftar
	</a>
</main>
